...
@section('content')
    ...
    <section id="hero" class="d-flex align-items-center" style="background: linear-gradient(rgba(0, 0, 128, 0.8), rgba(0, 0, 128, 0.8)), url('assets/img/1.jpg') center center; background-size: cover; height: 300px;">
        <div class="container text-center" data-aos="fade-up">
            ...
            <h2 class="text-white">Maestría en Derecho Civil</h2>
        </div>
    </section>

    <!-- ======= Seccion Maestría en Derecho Civil ======= -->
            ...
            <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel" data-interval="3500">
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <img src="assets\img\Macu\MacuDerecho.webp" class="d-block w-100" alt="Maestria en Derecho Civil">
                    </div>
            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 mt-4 mt-md-0" data-aos="fade-up" data-aos-delay="200">
                    <div class="box featured">
                        ...
                        <p class="text-left">
                            ✔ Desempeñarse en el ámbito público como privado, así como en servicios de consultoría.<br>
                            ✔ Desarrollar actividades que le permitan la resolución de conflictos en el aspecto de Derecho Civil y la correcta toma de decisiones a nivel de las empresas o instituciones en que se desenvuelva.<br>
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 mt-4 mt-md-0" data-aos="fade-up" data-aos-delay="200">
                    <div class="box featured">
                        ...
                        <p class="text-left">
                            Tener conocimientos en Derecho, así como la disposición necesaria para introducirse en el ámbito público y privado, para poder participar en el desarrollo teórico y técnico de la doctrina jurídica.
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 mt-4 mt-md-0" data-aos="fade-up" data-aos-delay="200">
                    <div class="box featured">
                        ...
                        <p class="text-left">
                            El alumno podrá desempeñarse en servicios de consultoría, implementando sus conocimientos para solucionar de manera correcta los conflictos que se les presenten en el aspecto privado y público del Derecho Civil.
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 mt-4 mt-md-0" data-aos="fade-up" data-aos-delay="200">
                    <div class="box featured">
                        ...
                        <p class="text-left">
                            ✔ Responsabilidad ante su trabajo.<br>
                            ✔ Ética profesional.<br>
                            ✔ Analítico.<br>
                            ✔ Interpretación de las leyes que integran las bases jurídicas.<br>
                            ✔ Desenvolvimiento verbal.<br>
                        </p>
                    </div>
                </div>
            </div>
                        ...
                        <div class="accordion" id="accordionDocumentos">
                            ...
                            <div class="accordion-item" data-aos="fade-up" data-aos-delay="250">
                                ...
                                <div id="collapsePlan2002" class="accordion-collapse collapse" 
                                    ...
                                    <div class="accordion-body p-0">
                                        <div class="documento-iframe-container">
                                            <iframe src="https://drive.google.com/file/d/1DAC87WRuTBKE91HlW87yLKrDvJgpxb9R/preview" 
                                                    width="100%" 
                                                    height="500" 
                                                    loading="lazy"
