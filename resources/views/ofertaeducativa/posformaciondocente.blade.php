...
@section('content')
    ...
    <section id="hero" class="d-flex align-items-center" style="background: linear-gradient(rgba(0, 0, 128, 0.8), rgba(0, 0, 128, 0.8)), url('assets/img/1.jpg') center center; background-size: cover; height: 300px;">
        <div class="container text-center" data-aos="fade-up">
            ...
            <h2 class="text-white">Maestría en Formación Docente</h2>
        </div>
    </section>

    <!-- ======= Seccion Maestría en Formación Docente ======= -->
            ...
            <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel" data-interval="3500">
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <img src="assets/img/Macu/MacuFormacion.webp" class="d-block w-100" alt="Maestría en Formación Docente">
                    </div>
            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 mt-4 mt-md-0" data-aos="fade-up" data-aos-delay="200">
                    <div class="box featured">
                        ...
                        <p class="text-left">
                            ✔ Desempeñarse como Director del área financiera de una empresa.<br>
                            ✔ Realizar actividades de consultoría y/o asesoría en el área financiera.<br>
                            ✔ Tomar decisiones acertadas para la resolución de problemas empresariales y sociales.
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 mt-4 mt-md-0" data-aos="fade-up" data-aos-delay="200">
                    <div class="box featured">
                        ...
                        <p class="text-left">
                            Ser responsable y estar comprometido con su desarrollo profesional, tener la disposición para desarrollarse en el campo de Dirección de Empresas, así como también analizar los problemas que se presenten en su entorno.
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 mt-4 mt-md-0" data-aos="fade-up" data-aos-delay="200">
                    <div class="box featured">
                        ...
                        <p class="text-left">
                            El profesional al terminar la maestría habrá adquirido habilidades y talentos específicos, los cuales enriquecen sus conocimientos y cualidades, como la creatividad y la resolución de problemas para mejorar su desempeño dentro del mundo laboral.
                        </p>
                    </div>
                </div>
            </div>
                ...
                <div class="col-lg-12 col-md-12 mt-4 mt-md-0" data-aos="fade-up" data-aos-delay="200">
                    <div class="box featured">
                        ...
                        <p class="text-left">
                            ...
                            ✔ Liderazgo.<br>
                            ✔ Formular e implementar estrategias adecuadas para cada organización.<br>
                        ...
                        <div class="accordion" id="accordionDocumentos">
                            ...
                            <div class="accordion-item" data-aos="fade-up" data-aos-delay="250">
                                ...
                                <div id="collapsePlan2002" class="accordion-collapse collapse" 
                                    ...
                                    <div class="accordion-body p-0">
                                        <div class="documento-iframe-container">
                                            <iframe src="https://drive.google.com/file/d/1STS1h0gxXlERnP1PYxDYcT5-qKVQg7F5/preview" 
                                                    width="100%" 
                                                    height="500" 
                                                    loading="lazy"
